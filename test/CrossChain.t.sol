...
contract CrossChainTest is Test {
    ...
    function configureTokenPool(
        ...
        chainsToAdd[0] = TokenPool.ChainUpdate({
            remoteChainSelector: remotChainSelector,
            allowed: true,
    ...
    function bridgeTokens(
        ...
        uint256 localBalBefore = localToken.balanceOf(user);
        vm.prank(user);
        ...
        uint256 remoteBalBefore = remoteToken.balanceOf(user);
